...
const CreateContact = () => {
  ...
  return (
    <div className="p-4 max-w-2xl ml-[396px]  ">
      <form
      ...
      >
        <div className="flex items-center justify-between mb-5">
          ...
          <button
            className="bg-blue-500  hover:bg-blue-700 text-white font-bold py-2 px-5 rounded-3xl shadow focus:outline-none focus:shadow-outline"
            type="submit"
          >
            Save
          </button>
